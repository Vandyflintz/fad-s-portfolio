...
reply.sender_id AS `reply-sender`, admin.*, reply.message AS `reply-message`, reply.modified_message AS `reply-modified-message`
FROM
messages main
LEFT JOIN
messages reply ON main.parent_id = reply.id
LEFT JOIN `admin` ON (
admin.userid = main.sender_id
OR admin.userid = reply.recipient_id
OR admin.userid = reply.sender_id
OR admin.userid = main.recipient_id
)
where (main.sender_id = '".$rec."' AND main.recipient_id != '".$rec."')
OR (main.sender_id != '".$rec."' AND main.recipient_id = '".$rec."')
ORDER BY
main.time_of_msg;");
